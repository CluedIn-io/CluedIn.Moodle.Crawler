...
{
    public class Moodle_Command_MeshProcessor : BaseMeshProcessor
    {
        public Moodle_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          MoodleConstants.ProviderId;

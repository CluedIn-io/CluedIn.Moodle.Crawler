...
namespace CluedIn.Crawling.Moodle.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IMoodleClientFactory>().AsFactory())
                .Register(Component.For<MoodleClient>().LifestyleTransient());

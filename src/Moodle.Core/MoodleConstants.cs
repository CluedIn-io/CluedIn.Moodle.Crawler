...
namespace CluedIn.Crawling.Moodle.Core
{
    public class MoodleConstants
    {
        ...
        public const string CrawlerDescription = "Moodle is a ... to be completed ...";
        ...
        // src\Moodle.Provider\Resources\cluedin.png
        ...
        public const string CodeOrigin = "Moodle";
        public const string ProviderRootCodeValue = "Moodle";
        public const string CrawlerName = "MoodleCrawler";
        public const string CrawlerComponentName = "MoodleCrawler";
        public static readonly Guid ProviderId = Guid.Parse("56f8e4c6-4cd6-417b-952b-9d04ba9f2737");
        public const string ProviderName = "Moodle";

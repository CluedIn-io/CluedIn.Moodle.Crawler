...
{
    public class GetHelperConfigurationBehaviour : MoodleProviderTest
    {
        private readonly CrawlJobData _jobData;

        public GetHelperConfigurationBehaviour()
        {
            _jobData = new MoodleCrawlJobData();
        }
        ...
        [Theory]
        [InlineAutoData("WebserviceToken", "WebserviceToken", "some-value")]
